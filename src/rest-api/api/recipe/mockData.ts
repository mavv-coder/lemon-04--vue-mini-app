...
export const mockRecipes: Recipe[] = [
  {
    ...
    steps: [
      ...
      'In a large bowl, whisk together eggs, milk, tomatoes, and Parmesan. Fold in the mushroom mixture and season again with salt and pepper. Pour into a 8" to 9" pie dish and bake until eggs are just set, 18 to 20 minutes. Let cool 3 minutes before slicing and serving.',
    ],
  },
  {
    id: 2,
    ...
    steps: [
      "In a food processor, puree strawberries then add to a small saucepan with sugar and lemon juice. Place over medium low heat. Cook, stirring often, until thickened and reduce by about half, about 20 minutes. You should have about 1½ cups of strawberry compote. Remove from heat and let cool completely.",
      ...
      "Make frosting: In a large bowl using a hand mixer, beat cream cheese and butter until no lumps remain, then beat in strawberry compote. Add powdered sugar and beat until fully incorporated. Add vanilla and a pinch of salt. If your frosting is too loose, refrigerate for 20 minutes before frosting the cake.",
  ...
  },
  {
    ...
    steps: [
      ...
      "Transfer broccoli to a large bowl and add egg, 1 cup mozzarella, Parmesan, and garlic. Season with oregano, salt, and pepper. Transfer dough to baking sheet and shape into a thin, round crust.",
      "Bake until golden and dried out, 20 minutes. Top with with remaining 1/2 cup mozzarella and bake until cheese is melted and crust is crispy, about 5 minutes.",
      "Garnish with parsley and pepper flakes if using. Serve warm with marinara.",
    ],
  },
  {
    id: 4,
  ...
  },
  {
    ...
    difficulty: "Medium",
    imgUrl: noBakePumpkinCheesecake,
    time: 25,
    description:
  ...
  },
  {
    ...
    steps: [
      "Preheat oven to 450°. Cut polenta in half crosswise. Cut each half into ½-inch thick planks. Cut each plank into four ½-inch fries.",
      "Place polenta wedges on a rimmed baking sheet, drizzle with oil, and season with salt and pepper. Turn gently to coat with oil and arrange in a single layer.",
      "Bake, turning halfway through, until golden and crisp, about 40 minutes.",
      "Meanwhile, in a small bowl, stir together mayonnaise, garlic, lemon juice, parsley and mustard. Season with salt and pepper.",
      "Transfer cooked fries to a serving platter. Sprinkle with parmesan cheese and parsley and serve with ketchup and garlic mayo.",
    ],
  },
];
